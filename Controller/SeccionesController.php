...
class SeccionesController{
    ...
    public function __CONSTRUCT(){
        $this->model = new Secciones();
    }

   /** Inicio de llamado de la vistas */
    public function Index(){
        require_once 'views/backend/header.php';
        require_once 'views/backend/secciones/index.php';
        require_once 'views/backend/footer.php';
    }
    public function Nuevo(){
        require_once 'views/backend/header.php';
        require_once 'views/backend/secciones/crear.php';
        require_once 'views/backend/footer.php';
    }
    ...
    public function Editar(){
        ...
        require_once 'views/backend/header.php';
        require_once 'views/backend/secciones/editar.php';
        require_once 'views/backend/footer.php';
    }
    public function Borrar(){
        ...
        $id = $_REQUEST['id'];
        require_once 'views/backend/header.php';
        require_once 'views/backend/secciones/borrar.php';
        require_once 'views/backend/footer.php';
    }
