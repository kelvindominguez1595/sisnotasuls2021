                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="?view=Autentificacion&action=autentificar">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="usuario" aria-describedby="emailHelp" name="usuario" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
