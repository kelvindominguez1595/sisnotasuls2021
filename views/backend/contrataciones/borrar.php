  ...
  <div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <a href="?view=Contrataciones&action=registrar" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-save fa-sm "></i> Crear nuevo rol</a>
    </div>
    <div clas="row">
        ...
        <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="?view=Contrataciones&action=borrar" method="post" class="user">
